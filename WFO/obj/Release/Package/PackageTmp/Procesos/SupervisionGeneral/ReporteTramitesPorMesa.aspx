...
<style>
    ...
    <script>
        ...
        function resultado(data) {
            ...
            var tabla = "<table id='Infomacion' class='table  table-responsive table-striped table-bordered table-hover jambo_table bulk_action text-center' style='width:100%'>" +
                "<thead>" +
                "<tr>" +
                "<td>Fecha envío</td>" +
               /* "<td>Tipo trámite</td>" +*/
