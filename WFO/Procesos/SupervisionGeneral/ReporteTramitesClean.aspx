...
<script>
    ...
    function resultadoBitacora(data) {
        ...
        var tabla = "<table id='InfomacionBitacora' class='table  table-responsive table-striped table-bordered jambo_table bulk_action table-hover' style='width:100%'>" +
            "<thead>" +
            "<tr>" +
    ...
    function resultado(data) {
        ...
        var tabla = "<table id='InfomacionMesas' class='table table-striped table-bordered jambo_table bulk_action table-hover' style='width:100%'>" +
            "<thead>" +
            "<tr>" +
            "<td></td>" +
            "<td>Fecha envió</td>" +
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <asp:Repeater ID="rptTramites" runat="server">
                            <HeaderTemplate>
                                <table id="example" class="table table-striped table-bordered jambo_table bulk_action table-hover" style='width:100%'>
                                    <thead>
                                        <tr >
                                            <%--<th>Id Trámite</th>--%>
                                            <th>Folio</th>
