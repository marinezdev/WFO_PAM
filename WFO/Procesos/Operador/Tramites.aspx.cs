...
namespace WFO.Procesos.Operador
{
    public partial class Tramites : Utilerias.Comun
    {
        ...
        protected void BtnConsultar_Click(object sender, EventArgs e)
        {
            ...
            DateTime fechaTermino = Convert.ToDateTime(dtFechaTermino.Text);
            ...
            if (DateTime.Compare(fechaTermino, fechaInicio) < 0)
            {
                string script2 = "";
                script2 = "retirar();";
            ...
            else
            {
                ...
                {
                    manejo_sesion = (WFO.IU.ManejadorSesion)Session["Sesion"];
                    List<prop.Tramites> Tramites = tramites.TramiteOperadorSelecionar(manejo_sesion.Usuarios.IdUsuario, fechaInicio, fechaTermino, Folio, RFC, Nombre, ApPaterno, ApMaterno);
        ...
        private void FormatosFechas()
        {
            ...
            dtFechaInicio.Date = Fecha.AddMonths(-1);
