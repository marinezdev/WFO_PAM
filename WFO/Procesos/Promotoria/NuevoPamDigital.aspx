                    ...
                    <div class="container">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                            <div class="card">
                                ...
                                <h2><small style="color:#007CC3"> TRAMITE NUEVO - PAM DIGITAL   </small></h2>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <asp:Label runat="server" ID="lblNumPolizaSolicitud" Text="* Número de " Font-Bold="True" class="control-label col-md-4 col-sm-4 col-xs-12"></asp:Label>
                                            <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
